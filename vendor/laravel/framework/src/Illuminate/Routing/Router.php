...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
            ...
            $this->get('login', 'User\Auth\LoginController@showLoginForm')->name('login');
            $this->post('login', 'User\Auth\LoginController@login');
            $this->post('logout', 'User\Auth\LoginController@logout')->name('logout');

            // Registration Routes...
            $this->get('register', 'User\Auth\RegisterController@showRegistrationForm')->name('register');
            $this->post('register', 'User\Auth\RegisterController@register');

            // Password Reset Routes...
            $this->get('password/reset', 'User\Auth\ForgotPasswordController@showLinkRequestForm')->name('password.request');
            $this->post('password/email', 'User\Auth\ForgotPasswordController@sendResetLinkEmail')->name('password.email');
            $this->get('password/reset/{token}', 'User\Auth\ResetPasswordController@showResetForm')->name('password.reset');
            $this->post('password/reset', 'User\Auth\ResetPasswordController@reset');
    }
