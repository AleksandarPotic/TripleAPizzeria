    ...
    <div class="row">
        <div class="container">
            <form id="form-customize" action="{{ route('customizeUser.updateRow') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12">
                        <h3 id="caption" class="text-center">{{ $item->name }}</h3>
                ...
                <div class="element-container" id="size-container1">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="small" id="size1" @if($item->options->size == 'small') checked @endif>
                ...
                <div class="element-container" id="size-container2">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="medium" id="size2" @if($item->options->size == 'medium') checked @endif>
                ...
                <div class="element-container" id="size-container3">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="large" id="size3" @if($item->options->size == 'large') checked @endif>
                ...
                <div class="element-container" id="size-container4">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="xlg" id="size4" @if($item->options->size == 'xlg') checked @endif>
                                    ...
                                    <div class="col-12 offset-md-2 col-md-8">
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            ...
                                            <div class="col-5 text-left">
                                                <label class="form-check-label labela">{{ $customize->name }} <span class="cena current_cena" @foreach($item->options->no_toppings_id as $pro_cu) @if($pro_cu == $customize->id) style="display: none" @endif @endforeach>
                                ...
                                <div class="row">
                                    <div class="col-12 offset-md-2 col-md-8">
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            ...
                                            <div class="col-5 text-left">
                                                <label class="form-check-label labela">{{ $customize->name }} <span class="cena premium_cena" @foreach($item->options->no_toppings_id as $pro_cu) @if($pro_cu == $customize->id) style="display: none" @endif @endforeach>
                                                    @if($item->options->size == 'small')
                                                        ${{ number_format($customize->customize_price,2) }}
                                                        @elseif($item->options->size == 'medium')
                                                            ${{ number_format($customize->medium_price,2) }}
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-left col-sm-3 col-md-3 text-md-left">
                                        <input id="quant" type="number" onchange="changeTotalPrice()" name="quantity" min="1" max="10" value="{{ $item->qty }}">
                                    </div>
                                    <div id="final-price" class="col-12 text-center col-sm-6 text-sm-right col-md-6 text-md-right">
                                        <span style="color:white" id="total_price_t">Current Price: ${{ number_format($item->price * $item->qty,2) }} </span>
                                    </div>
