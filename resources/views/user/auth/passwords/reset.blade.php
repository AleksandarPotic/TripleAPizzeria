                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-lg-6 offset-lg-3" id="left-check" style="text-align: center">
                            <h4><b>Enter email and new password!</b></h4>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input class="form-control" type="password" name="password" id="Fname" placeholder="Enter new password" required="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input class="form-control" type="password" name="password_confirmation" id="Fname" placeholder="Confirm password" required="">
                                </div>
                            </div>
                            <div class="row">
