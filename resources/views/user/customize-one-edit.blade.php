...
<div class="container-fluid" id="container">
    ...
    <div class="row">
        <div class="container">
            <form id="form-customize" action="{{ route('customizeUser.updateRow') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <h3 id="caption" class="text-center">Pizza Customize</h3>
            ...
            <!--
                ...
                -->
                <input type="hidden" name="product_id" value="{{ $item->options->product_id }}">
                <input type="hidden" name="descriptions" value="{{ $item->options->descriptions }}">
                ...
                <div class="element-container" id="size-container1">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="small" id="size1" disabled>
                                    <input type="hidden" value="{{ $product->small }}">
                                    <span class="checkmark" onclick="clickRadio(this),changePrice('small')"></span>
                                </div>

                                <div class="col-5 text-left">
                                    <label class="form-check-label labela">Small <span class="cena"> {{ $product->small }}</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="element-container" id="size-container2">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="medium" id="size2" checked>
                                    <input type="hidden" value="{{ $product->medium }}">
                                    <span class="checkmark" onclick="clickRadio(this),changePrice('medium')"></span>
                                </div>

                                <div class="col-12 text-left">
                                    <label class="form-check-label labela">Medium (12") <span class="cena"> $0.00</span></label>
                                </div>
                            </div>
                        </div>
                    </div> <!-- zatvara se veliko row -->
            ...
            <!--
                <div class="element-container" id="size-container3">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="large" id="size3" disabled>
                                    <input type="hidden" value="{{ $product->large }}">
                                    <span class="checkmark" onclick="clickRadio(this),changePrice('large')"></span>
                                </div>

                                <div class="col-5 text-left">
                                    <label class="form-check-label labela">Large <span class="cena"> {{ $product->large }}</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="element-container" id="size-container4">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="xlg" id="size4" disabled>
                                    <input type="hidden" value="{{ $product->xlg }}">
                                    <span class="checkmark" onclick="clickRadio(this),changePrice('xlg')"></span>
                                </div>

                                <div class="col-5 text-left">
                                    <label class="form-check-label labela">Extra Large <span class="cena"> {{ $product->xlg }}</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <input type="hidden" name="used_points" value="15">
                                        ...
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            <div class="col-1 text-center">
                                                <input name="topping-name" class="form-check-input default-check cheese-checked topping-c" type="checkbox" value="{{ $customize->name }}" id="{{ $customize->name }}cheeses{{ $customize->id }}"
                                                       @if($item->options->cheeses_name)
                                                       @foreach($item->options->cheeses_name as $item_cu)
                                                       @if($item_cu == $customize->name.' (Full)' or $item_cu == $customize->name.' (Right)' or $item_cu == $customize->name.' (Left)')
                                                       checked
                                                        @endif
                                                        @endforeach
                                                        @endif
                                                ...
                                                @foreach($item->options->no_toppings_id as $pro_cu)
                                                    @if($pro_cu == $customize->id)
                                                        <input type="hidden" name="noToppingId[]" value="{{ $customize->id }}">

                                                        <input type="hidden" id="noTopping{{ $customize->name }}" name="noTopping[]"
                                                               @foreach($item->options->no_toppings as $pro_cu_no)
                                                               @if($pro_cu_no == 'NO '.$customize->name)
                                                               value="NO {{ $customize->name }}"
                                                                @endif
                                                                @endforeach >
                                                    @endif
                                                @endforeach
                                            ...
                                            <div class="col-5 text-left">
                                                <label class="form-check-label labela">{{ $customize->name }} <span class="cena current_cena">
                                        ...
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center drop">
                                            <div style="padding-top: 20px;" class="form-group">
                                                ...
                                                <select class="form-control sel1" name="cheeses_name[]" disabled="" id="{{ $customize->name }}">
                                                    <option value="{{ $customize->name }} (Full)"
                                                            @if($item->options->cheeses_name)
                                                            @foreach($item->options->cheeses_name as $item_cu)
                                                            @if($item_cu == $customize->name.' (Full)')
                                                            selected
                                                            @endif
                                                            @endforeach
                                                            @endif>Full Pizza</option>
                                                    <option value="{{ $customize->name }} (Right)"
                                                            @if($item->options->cheeses_name)
                                                            @foreach($item->options->cheeses_name as $item_cu)
                                                            @if($item_cu == $customize->name.' (Right)')
                                                            selected
                                                            @endif
                                                            @endforeach
                                                            @endif>Right Half</option>
                                                    <option value="{{ $customize->name }} (Left)"
                                                            @if($item->options->cheeses_name)
                                                            @foreach($item->options->cheeses_name as $item_cu)
                                                            @if($item_cu == $customize->name.' (Left)')
                                                            selected
                                                            @endif
                                                            @endforeach
                                                            @endif>Left Half</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 offset-md-2 col-md-8">
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            ...
                                            <div class="col-5 text-left">
                                                <label class="form-check-label labela">{{ $customize->name }} <span class="cena premium_cena">
                                                    @if($item->options->size == 'small')
                                                            ${{ number_format($customize->customize_price,2) }}
                                                        @elseif($item->options->size == 'medium')
                                                            ${{ number_format($customize->medium_price,2) }}
                                        ...
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            <div class="col-1 text-center">
                                                <input name="topping-name" class="form-check-input default-check topping-c" type="checkbox" value="{{ $customize->name }}" id="{{ $customize->name }}meats{{ $customize->id }}"
                                                       @if($item->options->meats_name)
                                                       @foreach($item->options->meats_name as $item_cu)
                                                       @if($item_cu == $customize->name.' (Full)' or $item_cu == $customize->name.' (Right)' or $item_cu == $customize->name.' (Left)')
                                                       checked
                                                        @endif
                                                        @endforeach
                                        ...
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            <div class="col-1 text-center">
                                                <input name="topping-name" class="form-check-input default-check topping-c" type="checkbox" value="{{ $customize->name }}" id="{{ $customize->name }}veggies{{ $customize->id }}"
                                                       @if($item->options->veggies_name)
                                                       @foreach($item->options->veggies_name as $item_cu)
                                                       @if($item_cu == $customize->name.' (Full)' or $item_cu == $customize->name.' (Right)' or $item_cu == $customize->name.' (Left)')
                                                       checked
                                                        @endif
                                                        @endforeach
                ...
                <div class="row">
                    <div class="col-12 offset-md-1 col-md-10 offset-lg-2 col-lg-8">
                        <button type="button" onclick="addToCart()" class="btn btn-warning btn-block">Add to Cart</button>
                    </div>
                </div>
                <br>
                -->
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-left col-sm-3 col-md-3 text-md-left">
                                        <input id="quant" type="number" min="1" max="10" value="1" disabled>
                                        <input id="quant" type="hidden" name="quantity" value="1">
                                    </div>
                                    <div id="final-price" class="col-12 text-center col-sm-6 text-sm-right col-md-6 text-md-right">
                                        <span style="color:white" id="total_price_t">Current Price: ${{ number_format($item->price,2) }} </span>
                                    </div>
...
<script>
    ...
    function changeTotalPrice() {
        ...
        $("#total_price_t").text('Current Price: $' +parseFloat(totalPrice).toFixed(2));
    }
