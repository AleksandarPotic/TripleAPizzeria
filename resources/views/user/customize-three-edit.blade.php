    ...
    <div class="row">
        <div class="container">
                ...
                <div class="element-container" id="size-container1">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="small" id="size1" checked>
                ...
                <div class="element-container" id="size-container2">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="medium" id="size2">
                                    <input type="hidden" value="{{ $product->medium }}">
                                    <span class="checkmark" onclick="clickRadio(this),changePrice('medium')"></span>
                                </div>

                                <div class="col-5 text-left">
                                    <label class="form-check-label labela">Medium <span class="cena"> {{ $product->medium }}</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="element-container" id="size-container3">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="large" id="size3" checked>
                                    <input type="hidden" value="{{ $product->large }}">
                                    <span class="checkmark" onclick="clickRadio(this),changePrice('large')"></span>
                                </div>

                                <div class="col-12 text-left">
                                    <label class="form-check-label labela">Large (16") <span class="cena"> $0.00</span></label>
                                </div>
                            </div>
                        </div>
                    </div> <!-- zatvara se veliko row -->
            ...
            <!--
                <div class="element-container" id="size-container4">
                    <div class="row">
                        <div class="col-12 offset-md-2 col-md-8">
                            <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                <div class="col-1 text-center">
                                    <input name="size_radio" class="form-check-input default-check size-checked" type="radio" value="xlg" id="size4">
                ...
                <input type="hidden" name="used_points" value="30">
