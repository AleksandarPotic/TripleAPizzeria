                                ...
                                <div class="row">
                                    <div class="col-12 offset-md-2 col-md-8">
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            ...
                                            <div class="col-5 text-left">
                                                <label class="form-check-label labela">{{ $customize->name }} <span class="cena current_cena"> ${{ number_format($customize->large_price,2) }}</span></label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 offset-md-2 col-md-8">
                                        <div class="col-xs-12 col-md-8 col-md-12 offset-lg-1 col-lg-10 align-items-center primary">
                                            ...
                                            <div class="col-5 text-left">
                                                <label class="form-check-label labela">{{ $customize->name }} <span class="cena premium_cena"> ${{ number_format($customize->large_price,2) }}</span></label>
                                            </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div id="final-price" class="col-12 text-center col-sm-6 text-sm-right col-md-6 text-md-right">
                                        <span style="color:white" id="total_price_t">Current Price: $0.00 </span>
                                    </div>
