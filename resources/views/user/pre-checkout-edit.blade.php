                    ...
                    <div class="col-12 col-sm-12 col-md-7 col-lg-7" id="form">
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input class="form-control" type="text" name="fName" id="fName" @if($fName) value="{{ $fName }}" @endif required="">
                            </div>
                            <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                <label for="lName">Last Name<font style="color: #e66001">*</font></label>
                                <input class="form-control" type="text" name="lName" id="lName" @if($lName) value="{{ $lName }}" @endif required="">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input class="form-control" type="email" name="email" id="email" @if($email) value="{{ $email }}" @endif required="">
                                <small>Enter a valid email address</small>
                            </div>
                            <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                <label for="pNumber">Phone Number<font style="color: #e66001">*</font></label>
                                <input class="form-control" type="number" name="pNumber" id="pNumber" @if($pNumber) value="{{ $pNumber }}" @endif required="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-7 col-lg-7" style="display: block;" id="store">
                        ...
                        <div id="delivery" style="display:none;">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <input class="form-control" type="text" name="street" id="street" @if($street) value="{{ $street }}" @endif disabled>
                                </div>
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                    <label for="sNumber">Street Number<font style="color: #e66001">*</font></label>
                                    <input class="form-control" type="number" name="city" id="city" @if($city) value="{{ $city }}" @endif disabled>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <input class="form-control" type="text" name="buzzer" id="buzzer" @if($buzzer) value="{{ $buzzer }}" @endif disabled>
                                </div>
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                    <label for="apartment_number">Apartment Number</label>
                                    <input class="form-control" type="text" name="apartment_number" id="apartment_number" @if($apartment_number) value="{{ $apartment_number }}" @endif disabled>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                    <label for="pCode">Postal Code<font style="color: #e66001">*</font></label>
                                    <input class="form-control" type="text" name="postal_code" id="postal_code" @if($postal_code) value="{{ $postal_code }}" @endif disabled>
                                </div>
                            </div>
                            <hr style="margin-top: 0px;">
                        </div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol style="background: #fff; padding-left: 0px; margin-bottom: 0px;" class="breadcrumb">
                                ...
                                @if(Cart::total() > 10)
                                    <li class="breadcrumb-item" id="button-delivery" style="color: gray;cursor: pointer;"><b>Change to Delivery (45-60 mins)</b></li>
                                @endif
                            </ol>
                        </nav>
                        <hr style="margin-top: 0px;">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-append date form_datetime" data-date="2018-04-21T15:25:00Z">
                                        <input class="form-control" id="for_later_date" name="order_time" type="text" value="{{ $order_time }}" readonly disabled>
                        ...
                        <div class="row extras" style="margin-top: 10px; margin-bottom: 30px">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                ...
                                <textarea class="form-control" style="border: 1px solid #e66001" name="specify_text_order" cols="60" rows="4" placeholder="ie: 'Knock on the side door' or 'Triple A is the best!'">{{ $specify_text_order }}</textarea>
                            </li>
                        </ul>
                    </div>
